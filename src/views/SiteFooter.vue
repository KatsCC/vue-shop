<template>
  <footer
    class="flex flex-col md:flex-row md:flex-wrap items-center justify-center gap-4 p-10 footer bg-base-200 text-base-content footer-center"
  >
    <ul class="flex">
      <li>
        <svg
    ...
    <div>
      <div class="grid grid-flow-col gap-4">
        ...
        <a
          rel="noreferrer noopener external"
          data-tip="github"
          class="tooltip ml-1 dark:fill-white"
